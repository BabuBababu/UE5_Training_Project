...
#include "UE5_Training_Project/AI/DNAirRaptureFindCheckPointTask.h"
...
UDNAirRaptureFindCheckPointTask::UDNAirRaptureFindCheckPointTask(FObjectInitializer const& object_initializer)
{
	NodeName = TEXT("AirRaptureFindCheckPointTask");
}



EBTNodeResult::Type UDNAirRaptureFindCheckPointTask::ExecuteTask(UBehaviorTreeComponent& owner_comp_in, uint8* NodeMemory_in)
{
	...
	ADNAirRaptureCharacter* self_actor = Cast<ADNAirRaptureCharacter>(self);

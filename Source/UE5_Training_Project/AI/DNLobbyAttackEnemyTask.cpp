...
#include "UE5_Training_Project/AI/DNLobbyAttackEnemyTask.h"
...
UDNLobbyAttackEnemyTask::UDNLobbyAttackEnemyTask(FObjectInitializer const& object_initializer)
{
	NodeName = TEXT("LobbyAttackEnemyTask");
	bNotifyTick = true;			// 틱 활성화
}

EBTNodeResult::Type UDNLobbyAttackEnemyTask::ExecuteTask(UBehaviorTreeComponent& owner_comp_in, uint8* NodeMemory_in)
{
...
void UDNLobbyAttackEnemyTask::TickTask(UBehaviorTreeComponent& owner_comp_in, uint8* NodeMemory_in, float DeltaSeconds)
{

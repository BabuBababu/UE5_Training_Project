...
#include "UE5_Training_Project/AI/DNBossCheckMoveToTask.h"
...
UDNBossCheckMoveToTask::UDNBossCheckMoveToTask(FObjectInitializer const& object_initializer)
{
	NodeName = TEXT("BossCheckMoveToTask");
}

EBTNodeResult::Type UDNBossCheckMoveToTask::ExecuteTask(UBehaviorTreeComponent& owner_comp_in, uint8* NodeMemory_in)
{
...
void UDNBossCheckMoveToTask::TickTask(UBehaviorTreeComponent& owner_comp_in, uint8* NodeMemory_in, float DeltaSeconds)
{
